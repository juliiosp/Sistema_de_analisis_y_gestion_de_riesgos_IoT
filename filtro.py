...
# Generar grafico de barras con las puntuaciones de información mutua
# plt.figure(figsize=(12, 8))
# sns.barplot(x='Informacion_Mutua', y='Caracteristica', data=mi_df, palette='viridis')
# plt.title('Puntuaciones de Información Mutua para todas las características', fontsize=16)
# plt.xlabel('Información Mutua', fontsize=14)
# plt.ylabel('Característica', fontsize=14)
# plt.xticks(fontsize=12)
# plt.yticks(fontsize=16)  # Ajusta el tamaño de los nombres del eje vertical
# plt.tight_layout() 
# plt.show()
